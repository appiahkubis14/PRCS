...
ALLOWED_HOSTS = ['*','lanmma.sktlive.com','192.168.3.15','172.20.10.3']
...
# Kowri Payment Settings
KOWRI_WEBHOOK_SECRET = os.getenv('KOWRI_WEBHOOK_SECRET', 'your-secret-key-here')
...
LOGGING = {
    ...
    'handlers': {
        'console': {  # This is the missing handler
            'level': 'INFO',
    ...
    'loggers': {
        'core.services.payment_service': {  # Your specific logger
            'handlers': ['console', 'file'],  # Now 'console' is defined
            'level': 'INFO',
            'propagate': False,
        },
        'django': {
